...
import fr.trendev.comptandye.utils.misc.EmailSender;
...
public class AuthenticationService {
    ...
    public String password(@QueryParam("size") int size) {
        String pwd = passwordManager.autoGenerate(size);
        try {
            this.emailSender.sendAutogeneratedPassword("julien.sie@gmail.com", pwd);
        } catch (MessagingException | UnsupportedEncodingException ex) {
            throw new WebApplicationException("Error sending an email",ex);
        }
        return pwd;
    }
