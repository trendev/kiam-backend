...
DROP TABLE IF EXISTS `BILL_OFFERING`;
...
DROP TABLE IF EXISTS `COLLECTIVE_GROUP_CLIENT`;
DROP TABLE IF EXISTS `COMMENT`;
DROP TABLE IF EXISTS `CUSTOMER_DETAILS`;
DROP TABLE IF EXISTS `CustomerDetails_COMMENTS`;
DROP TABLE IF EXISTS `EXPENSE`;
DROP TABLE IF EXISTS `EXPENSE_PAYMENTMODE`;
DROP TABLE IF EXISTS `Expense_CATEGORIES`;
DROP TABLE IF EXISTS `OFFERING`;
DROP TABLE IF EXISTS `OFFERING_OFFERING`;
DROP TABLE IF EXISTS `PACK`;
DROP TABLE IF EXISTS `PACK_SERVICES`;
...
DROP TABLE IF EXISTS `USER_ACCOUNT_COLLECTIVE_GROUP`;
DROP TABLE IF EXISTS `USER_ACCOUNT_EXPENSE`;
DROP TABLE IF EXISTS `USER_ACCOUNT_OFFERING`;
